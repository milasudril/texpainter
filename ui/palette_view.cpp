...
public:
	...
	void highlightMode(PixelStore::ColorIndex index, HighlightMode mode)
	{
...
Texpainter::Ui::PaletteView& Texpainter::Ui::PaletteView::highlightMode(
    PixelStore::ColorIndex index, HighlightMode mode)
{
