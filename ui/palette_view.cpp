...
namespace
{
	bool realloc_surface_needed(Texpainter::Model::Palette const& new_pal, Texpainter::Model::Palette const* old_pal)
	{
		if(old_pal == nullptr)
		{ return true;}
...
Texpainter::Ui::PaletteView::PaletteView(Container& cnt):
m_impl{new Impl{cnt}}
{}
...
Texpainter::Ui::PaletteView& Texpainter::Ui::PaletteView::eventHandler(void* event_handler, EventHandlerVtable const& vtable)
{
