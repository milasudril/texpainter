...
int main(int argc, char* argv[])
{
	...
	Texpainter::Ui::Toolbar<MenuAction, MenuActionTraits> toolbar{
	   box_outer, Texpainter::Ui::Box::Orientation::Horizontal};

	Texpainter::forEachEnumItem<MenuAction>(
	   [&toolbar](auto tag) { toolbar.get<tag.value>().label(MenuActionTraits<tag.value>::name); });
