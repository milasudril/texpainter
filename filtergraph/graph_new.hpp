//@	{
//@	 "targets":[{"name":"graph_new.hpp", "type":"include"}]
//@	,"dependencies_extra":[{"ref":"graph_new.o", "rel":"implementation"}]
//@	}

#ifndef TEXPAINTER_FILTERGRAPH_GRAPHNEW_HPP
#define TEXPAINTER_FILTERGRAPH_GRAPHNEW_HPP
