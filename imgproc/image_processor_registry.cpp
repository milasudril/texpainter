...
//@		"./separate_rgba_image.imgproc.hpp",
...
//@		"./separate_amplitude_and_phase.imgproc.hpp",
...
namespace
{
	...
	constexpr ImageProcessorDetailedInfo s_processors[] = {
	    ...
	    get_info<::SeparateRgbaImage::ImageProcessor>(),
	    ...
	    get_info<::SeparateAmplitudeAndPhase::ImageProcessor>(),
